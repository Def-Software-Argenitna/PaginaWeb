  ...
  const casos = [
    {
      ...
      texto: "Desde que integramos DEF Commerce, las filas de los clientes se acortaron a la mitad. El módulo offline nos salvó en tres caídas de conexión a nivel ciudad.",
      autor: "Martín R., Gerente de Operaciones"
    },
    {
      empresa: "Boutique Elegance",
      rubro: "Indumentaria",
      resultado: "Inventario Perfecto a 3 tiendas",
    ...
    <main className="new-main-content">
      ...
      <section className="new-info-section" style={{ paddingTop: '0' }}>
        <div className="info-grid">
          {casos.map((caso, i) => (
            <div key={i} className="glass-panel reveal" style={{ padding: '2.5rem', textAlign: 'left', transitionDelay: `${i * 0.15}s` }}>
