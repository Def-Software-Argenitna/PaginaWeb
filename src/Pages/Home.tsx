...
const SalesFeatures = [
  ...
  },
  {
    ...
    description: "Perfiles personalizados: Vendedor, Supervisor, Encargado, Administrador. Tú decides quién ve cada módulo."
  },
  {
      ...
      <section className="new-info-section">
        ...
        <div className="info-grid">
          {SalesFeatures.map((f, i) => (
            <div key={i} className="info-card glass-panel reveal" style={{ transitionDelay: `${i * 0.1}s` }}>
      ...
      <section className="cta-section" id="demo">
        <div className="cta-panel reveal">
          ...
          <p style={{ color: 'var(--text-dim)', fontSize: '1.2rem', marginBottom: '3rem', maxWidth: '600px', margin: '0 auto 3rem' }}>
            Experimente el futuro del software de gestión comercial. Instale la versión de prueba en segundos y descubra el impacto real en su productividad.
          </p>
