        ...
        <div className="glass-panel reveal" style={{ padding: '3rem', minHeight: '600px' }}>
          ...
          {activeTab === 'soporte' && (
            <div className="reveal active">
              ...
              <p style={{ color: 'var(--text-dim)', marginBottom: '2rem' }}>Genera consultas técnicas directas hacia nuestros ejecutivos. Los planes Profesional y Enterprise tienen prioridad alta (SLA &lt; 2 horas).</p>
